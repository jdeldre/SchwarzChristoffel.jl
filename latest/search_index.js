...

{
    ...
    "category": "function",
    "text": "parameters(map::ExteriorMap) -> Tuple{Vector{Complex128},Complex128}\n\nReturns a tuple of a vector of the prevertices and the complex factor of the mapping map.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> prev, C = parameters(map);\n\njulia> prev\n4-element Array{Complex{Float64},1}:\n       1.0+0.0im\n  0.376406-0.926455im\n -0.902383-0.430935im\n -0.186756+0.982406im\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "centroid(map::ExteriorMap) -> Complex128\n\nReturns the complex centroid position of the polygon described by the mapping map.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> centroid(map)\n-0.20919540229885059 - 0.04022988505747128im\n\n\n\n"
},

{
    ...
    "category": "function",
    "text": "Jmoment(map::ExteriorMap) -> Float64\n\nReturns the second area moment of the polygon described by the mapping map.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> Jmoment(map)\n1.5768333333333333\n\n\n\n"
},

{
    ...
    "category": "function",
    "text": "evaluate(zeta::Vector{Complex128},map::ExteriorMap,inside::Bool) -> Vector{Complex128}\n\nEvaluates the mapping map at the vector of points zeta, which are assumed to lie inside the unit circle if inside is true, or are assumed outside the unit circle if inside is false.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> zeta = [0.1,0.5-0.75im,-0.25-0.3im];\n\njulia> evaluate(zeta,map,true)\n3-element Array{Complex{Float64},1}:\n   -6.9344-7.68965im\n 0.0439774-1.11249im\n   2.41181-0.044779im\n\n\n\nevaluate(zeta::Vector{Complex128},map::ExteriorMap) -> Vector{Complex128}\n\nEvaluates the mapping map at the vector of points zeta, which are assumed to lie outside the unit circle.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> zeta = [1.0+3.0im,-2.0-2.0im,0.0+1.1im];\n\njulia> evaluate(zeta,map)\n3-element Array{Complex{Float64},1}:\n   0.81614+3.02956im\n  -2.25237-2.08523im\n -0.333104+0.975837im\n\n\n\n"
},

{
    ...
    "category": "function",
    "text": "evalderiv(zeta::Vector{Complex128},map::ExteriorMap,inside::Bool) -> Tuple{Vector{Complex128},Vector{Complex128}}\n\nEvaluates the first and second derivatives of the mapping map at the vector of points zeta, which are assumed to lie inside the unit circle if inside is true, or are assumed outside the unit circle if inside is false. The first entry in the tuple returned is the first derivative, the second entry is the second derivative.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> zeta = [0.1,0.5-0.75im,-0.25-0.3im];\n\njulia> dz, ddz = evalderiv(zeta,map,true);\n\njulia> dz\n3-element Array{Complex{Float64},1}:\n  67.2068+76.6284im\n -1.11666+0.544576im\n  3.99129-5.30641im\n\n\n\nevalderiv(zeta::Vector{Complex128},map::ExteriorMap) -> Tuple{Vector{Complex128},Vector{Complex128}}\n\nEvaluates the first and second derivatives of the mapping map at the vector of points zeta, which are assumed to lie outside the unit circle. The first entry in the tuple returned is the first derivative, the second entry is the second derivative.\n\nExample\n\njulia> p = Polygon([-1.0,0.2,1.0,-1.0],[-1.0,-1.0,0.5,1.0]);\n\njulia> map = ExteriorMap(p);\n\njulia> zeta = [1.0+3.0im,-2.0-2.0im,0.0+1.1im];\n\njulia> dz, ddz = evalderiv(zeta,map);\n\njulia> dz\n3-element Array{Complex{Float64},1}:\n 1.03053+0.00444992im\n 1.00696-0.0115011im\n 1.30078-0.266625im\n\n\n\n"
},
